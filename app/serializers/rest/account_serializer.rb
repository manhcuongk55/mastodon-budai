...
class REST::AccountSerializer < ActiveModel::Serializer
  ...
  attributes :id, :username, :acct, :display_name, :locked, :bot, :discoverable, :indexable, :group, :created_at,
             ...
             :show_media, :show_media_replies, :show_featured, :is_guardian, :trust_score,
             :campaign_pioneer, :is_seeking_verification
  ...
  def campaign_pioneer
    object.unavailable? ? false : object.campaign_pioneer
  end
end
